# ColaMD Feature Request Archive

Archived on 2026-09-05 to separate inherited ColaMD requests from the current DraftMD product. Status headings, version numbers, paths, and platform claims below are historical upstream context, not DraftMD support or release commitments. See [current requests](../feature-requests.md) and the [DraftMD roadmap](../roadmap.md).
